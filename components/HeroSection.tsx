  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center bg-cover bg-center bg-no-repeat overflow-hidden"
      ...
      <div className="absolute top-0 w-full flex justify-between items-center px-6 py-4 md:px-8">
        ...
        <a href="#" className="hidden md:inline-block px-6 py-2 bg-rose-900 text-white rounded-full hover:bg-green-600 hover:text-black transition">MULAI TRANSFORMASI</a>
      </div>
      ...
      >
        ...
        <span className="text-6xl font-extrabold text-rose-800"> untuk UMKM </span>
